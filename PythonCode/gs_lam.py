...
ax1.set_ylabel("Stomatal conductance, $g_s$, mol m$^{-2}$ s$^{-1}$", FontSize=14)
ax1.set_ylim(0, 50)
...
E_div_a = 0.12  # mol /m2 /s per leaf area
...
ax1.text(3.4, 33, 'E = 512 mmol m$^{-2}$ s$^{-1}$', rotation=-75, color='red', fontsize=7)
ax1.text(4.8, 41, 'E = 320 mmol m$^{-2}$ s$^{-1}$', rotation=-70, color='red', fontsize=8)
ax1.text(6.7, 35, 'E = 256 mmol m$^{-2}$ s$^{-1}$', rotation=-65, color='red', fontsize=8)
ax1.text(10.2, 27, 'E = 192 mmol m$^{-2}$ s$^{-1}$', rotation=-65, color='red', fontsize=7)
