...
pickle_in = open("../Fig6/Fig6.resistant_competition_WUS", "rb")
resistant = pickle.load(pickle_in)

pickle_in = open("../Fig6/Fig6.midrange_competition_WUS", "rb")
midrange = pickle.load(pickle_in)

pickle_in = open("../Fig6/Fig6.vulnerable_competition_WUS", "rb")
...
fig.savefig('../Fig6/gs_time_competition_WUS.pdf', bbox_inches='tight')
# ------------psi_x----------------
...
fig2.savefig('../Fig6/gs_psix_competition_WUS.pdf', bbox_inches='tight')
...
fig3.savefig('../Fig6/lam_t_competition_WUS.pdf', bbox_inches='tight')
...
fig4.savefig('../Fig6/PLC_t_competition_WUS.pdf', bbox_inches='tight')