...
legend1 = ax2.legend((vul_gl_noon, vul_gl_noon2, vul_gl_noon3, vul_gl_noon4, vul_gl_profit_noon),
                   ('10%', '15%', '17%', '20%', 'profit maximization'), fontsize='large', loc=2)

# fig2.savefig('../profit_compare/percent_noon.pdf', bbox_inches='tight')
...
# fig_morning.savefig('../profit_compare/percent_morning.pdf', bbox_inches='tight')
...
# fig_evening.savefig('../profit_compare/percent_evening.pdf', bbox_inches='tight')
