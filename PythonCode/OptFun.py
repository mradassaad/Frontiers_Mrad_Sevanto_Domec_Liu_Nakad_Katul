...
res_prof = root(gs_val_profit, gl,
                                args=(t, ca, k1_interp, k2_interp, cp_interp,
...
pickle_out = open("../profit_compare_new/profit_compare.16percent_3lambda", "wb")
