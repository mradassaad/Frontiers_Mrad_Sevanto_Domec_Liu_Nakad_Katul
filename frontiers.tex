...
\def\Authors{Assaad Mrad\,$^{1,*}$, Yanlan Liu\,$^{1}$, Mazen Nakad\,$^{1}$, Jean-Christophe Domec\,$^{1,2}$, Sanna Sevanto\,$^{3}$ and Gabriel Katul\,$^{1,4}$}
...
\title[Running Title]{A dynamic optimality principle for water use strategies explains isohydric to anisohydric plant responses} 
